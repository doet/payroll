            <form class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <span>
                            <input type="text" id="form-field-1" placeholder="Title" class="col-xs-1 input-sm" />
                        </span>  
                        <span>
                            <input type="text" id="form-field-2" placeholder="nama" class="col-xs-3 input-sm" />
                        </span>
                        <span>
                            <input type="text" id="form-field-3" placeholder="Title2" class="col-xs-3 input-sm" />
                        </span>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right">Input with Icon</label>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="form-field-6">Tooltip and help button</label>
