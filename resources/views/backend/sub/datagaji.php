            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <div class="col-sm-4">
                            <input class="input-sm form-control" type="text" placeholder="Gaji Pokok" onkeyup="formatNumber(this);" tabindex="4" />
                        </div>
                    
                        <label for="form-field-select-3" class="control-label col-sm-8 no-padding-right">Upah Harian</label>
                        <div class="col-sm-4">
                            <input class="input-sm form-control" type="text" placeholder="Upah Harian" onkeyup="formatNumber(this);" />
                        </div>
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <div class="col-sm-4">
                            <input class="input-sm form-control" type="text" placeholder="Zis" />
                        </div>
