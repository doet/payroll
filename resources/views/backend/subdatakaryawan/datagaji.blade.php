    ...
    <div class=" profile-user-info-striped col-xs-4">
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <span class="editable" id="setdate"><?php echo date('F Y')?></span>
            </div>
        </div>
        <div class="profile-info-row">
    ...
    <div class="form-group col-xs-4">
        <div class="col-xs-12">
            ...
            <div class="col-sm-8">
                <label>
                    <input data='otkomunikasi' class="ace enableselect" type="checkbox">
                    <span class="lbl"> </span>
                    <input id="ck_otkomunikasi" name="dgaji['otkomunikasi']" type="hidden" value="">
                </label>
                <select id="otkomunikasi" class="chosen-select form-control col-sm-3" style="float: right;max-width:112px;" data-placeholder="Pilih ...">
        ...
        <div class="col-xs-12">
            ...
            <div class="col-sm-8">
                <label>
                    <input data="otkontribusi" class="ace enableselect" type="checkbox">
                    <span class="lbl"> </span>
                    <input id="ck_otkontribusi" name="dgaji['otkontribusi']" type="hidden" value="">
                </label>
                <select id="otkontribusi"  class="chosen-select form-control col-sm-3" style="float: right;max-width:112px;" data-placeholder="Pilih ...">
        ...
        <div class="col-xs-12">
            ...
            <div class="col-sm-8">
                <label>
                    <input data="otrelokasi" class="ace enableselect" type="checkbox">
                    <span class="lbl"> </span>
                    <input id="ck_otrelokasi" name="dgaji['otrelokasi']" type="hidden" value="">
                </label>
                <select id="otrelokasi" class="chosen-select form-control col-sm-3" style="float: right;max-width:112px;" data-placeholder="Pilih ...">
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <div class="col-sm-4">
                            <input id="upahpokok" class="input-sm form-control" type="text" name="dgaji['upahpokok']" placeholder="upahpokok" style="text-align: right;" onkeyup="formatNumber(this);" tabindex="4" />
                        </div>

                        <label class="control-label col-sm-8 no-padding-right">Upah Harian</label>
                        <div class="col-sm-4">
                            <input id="upahharian" class="input-sm form-control" type="text" name="dgaji['upahharian']" placeholder="upahharian" style="text-align: right;" onkeyup="formatNumber(this);" tabindex="4" />
                        </div>

                        <label for="form-field-select-3" class="control-label col-sm-8 no-padding-right">Tunjangan Kontribusi</label>
                        <div class="col-sm-4">
                          <input id="tkontribusi" class="input-sm form-control" type="text" name="dgaji['tkontribusi']" placeholder="tkontribusi" style="text-align: right;" onkeyup="formatNumber(this);" tabindex="4" />
                        </div>

                        <label for="form-field-select-3" class="control-label col-sm-8 no-padding-right">Tunjangan Prestasi (old. Benefit)</label>
                        <div class="col-sm-4">
                            <input class="input-sm form-control" type="text" placeholder="Benefit" disabled/>
                        </div>

                        <label for="form-field-select-3" class="control-label col-sm-8 no-padding-right">Tunjangan Prestasi (T. Prestasi)</label>
                        <div class="col-sm-4">
                            <input id="tprestasi" class="input-sm form-control" type="text" name="dgaji['tprestasi']" placeholder="tprestasi" style="text-align: right;" onkeyup="formatNumber(this);" tabindex="4" />
                        </div>
                        ...
                        <div class="col-sm-4">
                            <input id="trelokasi" class="input-sm form-control" type="text" name="dgaji['trelokasi']" placeholder="trelokasi" style="text-align: right;" onkeyup="formatNumber(this);" tabindex="4" />
                        </div>

                        <label class="control-label col-sm-8 no-padding-right">Tunjangan Skill</label>
                        <div class="col-sm-4">
                            <input class="input-sm form-control" type="text" placeholder="Skill" disabled/>
                        </div>

                        <label for="form-field-select-3" class="control-label col-sm-8 no-padding-right">Tunjangan Jabatan</label>
                        <div class="col-sm-4">
                            <input id="tjabatan" class="input-sm form-control" type="text" name="dgaji['tjabatan']" placeholder="tjabatan" style="text-align: right;" onkeyup="formatNumber(this);" tabindex="4" />
                        </div>
                        <label for="form-field-select-3" class="control-label col-sm-8 no-padding-right">Tunjangan Komunikasi</label>
                        <div class="col-sm-4">
                            <input id="tkomunikasi" class="input-sm form-control" type="text" name="dgaji['tkomunikasi']" placeholder="tkomunikasi" style="text-align: right;" onkeyup="formatNumber(this);" tabindex="4" />
                        </div>
                        ...
                        <div class="col-sm-4">
                            <input id="finsentif" class="input-sm form-control" type="text" name="dgaji['finsentif']" placeholder="finsentif" style="text-align: right;" onkeyup="formatNumber(this);" tabindex="4" />
                        </div>

                        <label class="control-label col-sm-8 no-padding-right">Shift</label>
                        <div class="col-sm-4">
                            <input class="input-sm form-control" type="text" placeholder="Shift" disabled/>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <input class="input-sm form-control" type="text" placeholder="THR" disabled/>
                        </div>
                        <label for="form-field-select-3" class="control-label col-sm-8 no-padding-right">Honorarium (komisaris)</label>
                        <div class="col-sm-4">
                            <input class="input-sm form-control" type="text" placeholder="?" disabled/>
                        </div>
                ...
                success: function(msg) {
                  ...
                  for (var i = 0, len = msg.length; i < len; i++) {
                    if (msg[i] != null){
                      ...
                      // inputarray=['upahpokok','upahharian','tkontribusi','makan','transport','trelokasi','tjabatan','skill','shift','insentif','finsentif'];
