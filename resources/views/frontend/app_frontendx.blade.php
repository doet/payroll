            ...
            <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
                ...
                <ul class="nav nav-list">
                    <li <?php if ($page=='Dashboard')echo 'class="active"'?>">
                        <a href="http://localhost/devbar/public/">
                    ...
                    {!! recursive_helper::print_recursive($multilevel,$page,recursive_helper::aktif_menu($aktif_menu,$page)) !!}
                </ul><!-- /.nav-list -->
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <?php if ($page=='Dashboard')echo '<li>Dashboard</li>'?>
                            {!! recursive_helper::print_aktifmenu($aktif_menu,$page) !!}-
